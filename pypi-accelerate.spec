...
Source0  : https://files.pythonhosted.org/packages/51/0b/179cc63d3a4f52e8cb233f2153a3e5a417522c85ea4b1dd25f6f2b377369/accelerate-1.1.1.tar.gz
Summary  : Accelerate
...
%prep
%setup -q -n accelerate-1.1.1
cd %{_builddir}/accelerate-1.1.1
pushd ..
cp -a accelerate-1.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730994396
