...
Version  : 1.4.0
Release  : 44
URL      : https://files.pythonhosted.org/packages/8f/02/24a4c4edb9cf0f1e0bc32bb6829e2138f1cc201442e7a24f0daf93b8a15a/accelerate-1.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/8f/02/24a4c4edb9cf0f1e0bc32bb6829e2138f1cc201442e7a24f0daf93b8a15a/accelerate-1.4.0.tar.gz
Summary  : Accelerate
...
%prep
%setup -q -n accelerate-1.4.0
cd %{_builddir}/accelerate-1.4.0
pushd ..
cp -a accelerate-1.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739826721
