...
Version  : 1.3.0
Release  : 43
URL      : https://files.pythonhosted.org/packages/85/15/0fab0260ab4069e5224e637d2e400538bb27b0dfc36f17daf68db9770d78/accelerate-1.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/85/15/0fab0260ab4069e5224e637d2e400538bb27b0dfc36f17daf68db9770d78/accelerate-1.3.0.tar.gz
Summary  : Accelerate
...
%prep
%setup -q -n accelerate-1.3.0
cd %{_builddir}/accelerate-1.3.0
pushd ..
cp -a accelerate-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737390840
