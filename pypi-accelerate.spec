...
Version  : 0.24.1
Release  : 14
URL      : https://files.pythonhosted.org/packages/44/8d/b007e0591a5d95c0d6777933ea068a7610bfc2fb28a0fb2258670fc53244/accelerate-0.24.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/44/8d/b007e0591a5d95c0d6777933ea068a7610bfc2fb28a0fb2258670fc53244/accelerate-0.24.1.tar.gz
Summary  : Accelerate
...
%prep
%setup -q -n accelerate-0.24.1
cd %{_builddir}/accelerate-0.24.1
pushd ..
cp -a accelerate-0.24.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698699517
