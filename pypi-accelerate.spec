...
Version  : 0.25.0
Release  : 16
URL      : https://files.pythonhosted.org/packages/f8/7d/52c6f11bfeaae2d8dd95ca8923c4330bfe41ba2e3375209eaa7bbe41b04f/accelerate-0.25.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/f8/7d/52c6f11bfeaae2d8dd95ca8923c4330bfe41ba2e3375209eaa7bbe41b04f/accelerate-0.25.0.tar.gz
Summary  : Accelerate
...
%prep
%setup -q -n accelerate-0.25.0
cd %{_builddir}/accelerate-0.25.0
pushd ..
cp -a accelerate-0.25.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702062938
