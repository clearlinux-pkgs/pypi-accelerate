...
Source0  : https://files.pythonhosted.org/packages/c4/25/969456a95a90ed38f73f68d0f0915bdf1d76145d05054c59ad587b171150/accelerate-1.9.0.tar.gz
Summary  : Accelerate
...
%prep
%setup -q -n accelerate-1.9.0
cd %{_builddir}/accelerate-1.9.0
pushd ..
cp -a accelerate-1.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752684386
